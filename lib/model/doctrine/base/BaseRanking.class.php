 ...
 * @method integer             getPrts()              Returns the current record's "prts" value
 ...
 * @method Ranking             setPrts()              Sets the current record's "prts" value
...
abstract class BaseRanking extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('prts', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
